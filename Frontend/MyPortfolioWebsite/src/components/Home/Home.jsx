...
const Home = () => {
  return (
    <>
    <section id="home" className="min-h-screen bg-[#2D4739] flex flex-col md:flex-row items-center justify-between px-16 py-4">
    <div className="md:w-1/2 space-y-6">
      ...
      <p className="text-gray-400 text-lg">A passionate Web Developer skilled in React, Tailwind CSS, and MongoDB.</p>
      <div className="flex space-x-4">
        <a href="#" className="bg-green-950  border-4 border-yellow-500 text-white px-6 py-2 rounded-full font-bold shadow-lg shadow-green-950">View My Portfolio</a>
        <a href="#" className="border-2 border-white px-6 py-2 text-white rounded-full font-bold shadow-lg shadow-green-950">My resume</a>
      </div>
    </div>
